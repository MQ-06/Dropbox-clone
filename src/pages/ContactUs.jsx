...
const ContactUs = () => {
  return (
    <div className="max-w-7xl mx-auto p-8 grid grid-cols-1 md:grid-cols-2 gap-8 bg-white font-sans">
      ...
      <div className="px-16">
        <form action="#" method="POST" className="space-y-4">
          ...
          <div className="block text-sm text-black">
            ...
            product offerings, services, events, and other marketing materials.
            I may unsubscribe at any time. To learn more, see our
